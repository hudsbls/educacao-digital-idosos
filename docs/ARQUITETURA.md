...
| D8 | Identidade visual e marca | **DECIDIDA: paleta violeta vivo com âmbar para avisos** | 17 pares de contraste verificados por script (`npm run contraste`); ver `ACESSIBILIDADE.md`, 8.1 |
