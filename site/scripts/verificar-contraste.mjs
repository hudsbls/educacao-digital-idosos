...
const PARES = [
  ...
  { nome: 'Títulos (ocre) sobre branco', frente: 'primaria', fundo: 'papel', minimo: 7 },
  { nome: 'Texto do botão sobre ocre', frente: 'primariaTexto', fundo: 'primaria', minimo: 7 },
  { nome: 'Ocre sobre branco (bordas)', frente: 'primaria', fundo: 'papel', minimo: 3 },
  { nome: 'Rótulo de canal (oliva) sobre branco', frente: 'secundaria', fundo: 'papel', minimo: 7 },
  { nome: 'Rótulo de canal (oliva) sobre cinza', frente: 'secundaria', fundo: 'cinza', minimo: 7 },
  { nome: 'Borda oliva sobre branco', frente: 'borda', fundo: 'papel', minimo: 3 },
  { nome: 'Borda oliva sobre cinza', frente: 'borda', fundo: 'cinza', minimo: 3 },
  ...
  { nome: 'Anel de foco sobre o cabeçalho ocre', frente: 'primariaTexto', fundo: 'primaria', minimo: 3 },
